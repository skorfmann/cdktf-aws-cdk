    ...
    registerMapping("AWS::NetworkManager::VpcAttachment", {
...
VpcArn: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["VpcArn"]),
