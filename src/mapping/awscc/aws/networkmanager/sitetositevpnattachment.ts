    ...
    registerMapping("AWS::NetworkManager::SiteToSiteVpnAttachment", {
...
VpnConnectionArn: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["VpnConnectionArn"]),
      },
    })
