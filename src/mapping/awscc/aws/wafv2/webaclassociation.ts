    ...
    registerMapping("AWS::WAFv2::WebACLAssociation", {
...
WebACLArn: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["WebACLArn"]),
      },
    })
