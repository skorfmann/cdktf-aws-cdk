    ...
    registerMapping("AWS::ECR::PublicRepository", {
...
RepositoryCatalogData: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["RepositoryCatalogData"]),
