    ...
    registerMapping("AWS::ECR::RegistryPolicy", {
...
PolicyText: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["PolicyText"]),
      },
    })
