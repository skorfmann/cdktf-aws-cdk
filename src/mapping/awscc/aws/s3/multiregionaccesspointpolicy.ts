    ...
    registerMapping("AWS::S3::MultiRegionAccessPointPolicy", {
      ...
      attributes: {
        Ref: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["MrapName"]),
        MrapName: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["MrapName"]),
