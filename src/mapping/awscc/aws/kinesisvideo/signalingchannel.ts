    ...
    registerMapping("AWS::KinesisVideo::SignalingChannel", {
...
MessageTtlSeconds: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["MessageTtlSeconds"]),
