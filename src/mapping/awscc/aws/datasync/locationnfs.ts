    ...
    registerMapping("AWS::DataSync::LocationNFS", {
...
OnPremConfig: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["OnPremConfig"]),
