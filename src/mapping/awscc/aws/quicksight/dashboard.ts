    ...
    registerMapping("AWS::QuickSight::Dashboard", {
...
DashboardPublishOptions: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["DashboardPublishOptions"]),
LastPublishedTime: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["LastPublishedTime"]),
