    ...
    registerMapping("AWS::ApiGatewayV2::VpcLink", {
      ...
      attributes: {
        Ref: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["VpcLinkId"]),
        VpcLinkId: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["VpcLinkId"]),
