    ...
    registerMapping("AWS::ServiceCatalog::ServiceAction", {
...
DefinitionType: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["DefinitionType"]),
