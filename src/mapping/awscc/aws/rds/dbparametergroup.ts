    ...
    registerMapping("AWS::RDS::DBParameterGroup", {
      ...
      attributes: {
        Ref: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["DBParameterGroupName"]),
