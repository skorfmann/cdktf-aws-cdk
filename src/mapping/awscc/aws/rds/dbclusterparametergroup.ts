    ...
    registerMapping("AWS::RDS::DBClusterParameterGroup", {
      ...
      attributes: {
        Ref: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["DBClusterParameterGroupName"]),
