    ...
    registerMapping("AWS::CloudFront::OriginRequestPolicy", {
...
OriginRequestPolicyConfig: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["OriginRequestPolicyConfig"]),
      },
    })
