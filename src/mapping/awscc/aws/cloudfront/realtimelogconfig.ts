    ...
    registerMapping("AWS::CloudFront::RealtimeLogConfig", {
...
EndPoints: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["EndPoints"]),
