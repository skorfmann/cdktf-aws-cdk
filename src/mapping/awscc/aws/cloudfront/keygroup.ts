    ...
    registerMapping("AWS::CloudFront::KeyGroup", {
...
KeyGroupConfig: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["KeyGroupConfig"]),
