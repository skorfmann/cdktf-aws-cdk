    ...
    registerMapping("AWS::CloudFront::CachePolicy", {
      ...
      attributes: {
        ...
        CachePolicyConfig: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["CachePolicyConfig"]),
