    ...
    registerMapping("AWS::CloudFront::ContinuousDeploymentPolicy", {
      ...
      attributes: {
        ...
        ContinuousDeploymentPolicyConfig: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["ContinuousDeploymentPolicyConfig"]),
