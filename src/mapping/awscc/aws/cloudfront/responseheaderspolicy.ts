    ...
    registerMapping("AWS::CloudFront::ResponseHeadersPolicy", {
...
ResponseHeadersPolicyConfig: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["ResponseHeadersPolicyConfig"]),
      },
    })
