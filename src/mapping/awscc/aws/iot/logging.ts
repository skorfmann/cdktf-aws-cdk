    ...
    registerMapping("AWS::IoT::Logging", {
...
DefaultLogLevel: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["DefaultLogLevel"]),
      },
    })
