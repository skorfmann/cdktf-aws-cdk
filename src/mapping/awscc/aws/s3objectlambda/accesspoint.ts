    ...
    registerMapping("AWS::S3ObjectLambda::AccessPoint", {
...
ObjectLambdaConfiguration: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["ObjectLambdaConfiguration"]),
      },
    })
