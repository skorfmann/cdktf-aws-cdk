    ...
    registerMapping("AWS::IoTTwinMaker::Workspace", {
...
S3Location: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["S3Location"]),
