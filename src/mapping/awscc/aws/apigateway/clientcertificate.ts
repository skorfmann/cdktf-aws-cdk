    ...
    registerMapping("AWS::ApiGateway::ClientCertificate", {
      ...
      attributes: {
        Ref: (i: cloudcontrolapiResource.CloudcontrolapiResource) => propertyAccess(Fn.jsondecode(i.properties), ["ClientCertificateId"]),
